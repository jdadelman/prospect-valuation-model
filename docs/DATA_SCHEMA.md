...
### FanGraphs season snapshots (identity_key → mlbam_id, report_year)
...
### Ancillary files
Curated reference files (optional): src/resources/MLBAM_ancillary_data.csv may be used to supplement DOB/name fields for
identity resolution. This file is manually maintained and versioned; it is not generated by build steps.
